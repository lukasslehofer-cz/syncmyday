    ...
    form.addEventListener('submit', function(e) {
        ...
        overlay.innerHTML = `
            <div style="text-align: center;">
                ...
                <div style="background: rgba(255, 255, 255, 0.5); border-radius: 1rem; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.25); padding: 2rem; max-width: 28rem; margin: 0 1rem; border: 2px solid #e0e7ff; backdrop-filter: blur(10px);">
