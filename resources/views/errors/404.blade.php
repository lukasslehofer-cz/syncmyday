...
<head>
    ...
    <title>404 - {{ __('messages.error_404_page_title') }} | SyncMyDay</title>
...
<body class="bg-gradient-to-br from-indigo-50 via-white to-purple-50 antialiased pt-10 pb-10">
    <div class="min-h-screen flex flex-col items-center justify-center px-4 sm:px-6 lg:px-8">
        ...
        <div class="max-w-2xl mx-auto text-center">
            ...
            <p class="text-lg text-gray-600 mb-4 max-w-lg mx-auto">
                {{ __('messages.error_404_message') }} 🗓️
            </p>
            
            <p class="text-base text-gray-500 mb-8 max-w-md mx-auto">
                {{ __('messages.error_404_hint') }}
            </p>
            ...
            <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
                ...
                <a href="{{ route('dashboard') }}" class="inline-flex items-center px-6 py-3 bg-white hover:bg-gray-50 text-indigo-600 font-semibold rounded-xl shadow-md border-2 border-indigo-200 transition transform hover:scale-105">
                    ...
                    {{ __('messages.error_go_dashboard') }}
                </a>
                @else
        ...
        <div class="mt-16 text-center">
            <p class="text-sm text-gray-500">
                {{ __('messages.error_need_help') }} <a href="{{ route('contact') }}" class="text-indigo-600 hover:text-indigo-700 font-medium underline">{{ __('messages.contact_us') }}</a>
            </p>
        </div>
    </div>
</body>
