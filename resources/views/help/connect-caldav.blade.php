...
<div class="flex items-center mb-6">
    <div class="w-16 h-16 rounded-2xl bg-indigo-500 flex items-center justify-center mr-4">
...
<div class="p-6 bg-blue-50 border border-blue-200 rounded-xl mb-8">
    <div class="flex items-start">
        ...
        <div class="flex-1">
            <h3 class="text-lg font-semibold text-blue-900 mb-2 leading-tight">What is CalDAV?</h3>
