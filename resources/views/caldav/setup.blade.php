...
<div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    @if(session('error'))
        <div class="mb-6 bg-red-50 border-2 border-red-200 rounded-2xl p-6">
            <div class="flex items-start space-x-3">
                ...
                <div>
                    <h3 class="text-lg font-bold text-red-900 mb-1">{{ __('messages.connection_failed') }}</h3>
    ...
    @if(session('success'))
        <div class="mb-6 bg-green-50 border-2 border-green-200 rounded-2xl p-6">
            <div class="flex items-start space-x-3">
                <div class="flex-shrink-0">
                ...
                <div class="bg-yellow-50 border-2 border-yellow-200 rounded-xl p-4 mt-6">
                    <div class="flex items-start space-x-3">
                        ...
                        <div class="text-sm text-gray-700">
                            <strong class="text-gray-900">{{ __('messages.common_issues') }}</strong>
                            <ul class="mt-2 ml-4 list-disc space-y-1">
                                <li>{!! __('messages.apple_issue_1') !!}</li>
                                <li>{{ __('messages.apple_issue_2') }}</li>
                                <li>{{ __('messages.apple_issue_3') }}</li>
                                <li>{{ __('messages.apple_issue_4') }}</li>
                            </ul>
                        </div>
                    </div>
                </div>
