...
return [
    ...
    'no_card_required_bullets' => '✓ 30 days trial period<br>✓ Cancel anytime<br>✓ After trial only :price/year',
    'faq_title' => 'Frequently Asked Questions',
    'faq_trial_q' => 'How does the free trial month work?',
    'faq_trial_a' => 'After registration you have 30 days full access to all SyncMyDay Pro features completely free. You will enter a credit card, but no payment will be charged during the trial period. After 30 days, :price per year will be automatically charged.',
    ...
    'faq_after_trial_a' => 'After the 30-day trial period expires, the annual payment :price will be automatically charged from your credit card. If you do not wish to continue, cancel the subscription before the trial period ends.',
