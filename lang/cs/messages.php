...
return [
    ...
    'email_already_registered' => 'Tento e-mail je již zaregistrován. Použijte prosím původní metodu přihlášení nebo kontaktujte podporu.',
    'oauth_google_login_success' => 'Vítejte! Váš účet Google a kalendář byly úspěšně připojeny.',
    'oauth_microsoft_login_success' => 'Vítejte! Váš účet Microsoft a kalendář byly úspěšně připojeny.',
    'oauth_login_welcome_back' => 'Vítejte zpět! Byli jste úspěšně přihlášeni.',
    'oauth_google_login_failed' => 'Přihlášení přes Google selhalo. Zkuste to prosím znovu nebo použijte e-mail a heslo.',
    'oauth_microsoft_login_failed' => 'Přihlášení přes Microsoft selhalo. Zkuste to prosím znovu nebo použijte e-mail a heslo.',
    'oauth_account_created_approval_needed' => 'Vítejte! Váš účet byl vytvořen. Připojení kalendáře vyžaduje dodatečné schválení.',
    'oauth_login_welcome_back_approval_needed' => 'Vítejte zpět! Připojení kalendáře vyžaduje dodatečné schválení.',
    ...
    'deleting_sync_rule' => 'Mažeme synchronizační pravidlo',
    'deleting_sync_rule_message' => 'Odstraňujeme pravidlo a související události...',
    ...
    'change_subscription_interval' => 'Změnit interval předplatného',
    'current_interval' => 'Současný interval',
    'switch_to_monthly' => 'Přejít na měsíční',
    'switch_to_yearly' => 'Přejít na roční',
    'interval_change_notice_end_of_period' => 'Změna se projeví na konci vašeho současného fakturačního období. Do té doby budete pokračovat se současným plánem a nevzniknou žádné okamžité poplatky.',
    'interval_change_scheduled' => 'Vaše předplatné se změní na :interval dne :date.',
    'interval_change_error' => 'Nepodařilo se naplánovat změnu intervalu předplatného. Zkuste to prosím znovu nebo kontaktujte podporu.',
    'scheduled_interval_change' => 'Plánovaná změna plánu',
    'scheduled_interval_change_description' => 'Vaše předplatné se změní na :interval dne :date. Do té doby budete pokračovat se současným plánem.',
    'cancel_scheduled_change' => 'Zrušit plánovanou změnu',
    'scheduled_change_cancelled' => 'Plánovaná změna plánu byla zrušena.',
    'no_scheduled_change' => 'Nebyla nalezena žádná plánovaná změna plánu.',
    'yearly_savings_badge' => 'Ušetříte :percent%',
    'monthly_flexibility' => 'Větší flexibilita s měsíčním fakturováním',
    'invalid_interval' => 'Neplatný interval předplatného.',
    'subscription_not_active' => 'Vaše předplatné není aktivní.',
    'interval_already_set' => 'Vaše předplatné je již nastaveno na interval :interval.',
    'pricing_configuration_error' => 'Chyba v konfiguraci cen. Prosím kontaktujte podporu.',
    ...
    'start_free_trial_now' => 'Začít 14 dní zdarma',
    ...
    // Error Pages
    'error_403_title' => 'Přístup zamítnut',
    'error_403_message' => 'Nemáte oprávnění k přístupu na tuto stránku. Je to jako pokus otevřít cizí kalendář!',
    'error_403_hint' => 'Pokud si myslíte, že byste měli mít přístup, kontaktujte nás nebo se přihlaste jiným účtem.',
    'error_404_page_title' => 'Stránka nenalezena',
    'error_404_title' => 'Ouha! Tato událost nebyla nalezena',
    'error_404_message' => 'Vypadá to, že tato stránka byla nesynchronizována s realitou... nebo možná smazána rychleji, než jsme ji stihli najít.',
    'error_404_hint' => 'Možná se stránka přesunula, nebo jste klikli na starý odkaz. Zkusme vás vrátit zpátky na cestu!',
    'error_419_title' => 'Stránka vypršela',
    'error_419_message' => 'Vaše relace vypršela. To se stává, když je stránka otevřená příliš dlouho.',
    'error_419_hint' => 'Prosím, obnovte stránku a zkuste to znovu. Vaše data jsou v bezpečí!',
    'error_429_title' => 'Pomaleji, prosím!',
    'error_429_message' => 'Posíláte příliš mnoho požadavků najednou. Dejte nám chvilku na vydech!',
    'error_429_hint' => 'Počkejte prosím několik sekund a zkuste to znovu. Děkujeme za pochopení!',
    'error_500_title' => 'Jejda! Něco se pokazilo',
    'error_500_message' => 'Naše servery momentálně řeší neočekávaný problém. Už na tom pracujeme!',
    'error_500_hint' => 'Zkuste prosím stránku obnovit za chvíli. Pokud problém přetrvává, dejte nám vědět a my to co nejrychleji opravíme.',
    'error_503_title' => 'Momentálně probíhá údržba',
    'error_503_message' => 'Pracujeme na vylepšeních, abychom vám mohli poskytovat ještě lepší služby. Brzy budeme zpět!',
    'error_503_hint' => 'Zkuste to prosím za pár minut. Děkujeme za trpělivost!',
    'error_back_home' => 'Zpět na hlavní stránku',
    'error_go_dashboard' => 'Přejít na Dashboard',
    'error_sign_in' => 'Přihlásit se',
    'error_need_help' => 'Potřebujete pomoc?',

    // Admin Consent & Pending Approval
    'calendar_pending_approval' => 'Kalendář čeká na schválení',
    'calendar_connection_requires_approval' => 'Připojení kalendáře vyžaduje schválení',
    'work_account_requires_admin' => 'Váš pracovní kalendář potřebuje schválení IT administrátorem',
    'admin_consent_instructions' => 'Návod pro IT administrátora',
    'connect_different_calendar' => 'Připojit jiný kalendář',
    'admin_consent_url' => 'URL pro admin consent',
    'pending_admin_approval' => 'Čeká na schválení administrátorem',
    'waiting_for_it_admin' => 'Čeká na schválení IT administrátorem',
    'admin_consent_learn_more' => 'Zjistit více',
    'admin_consent_why_needed' => 'Proč je potřeba schválení administrátorem?',
    'admin_consent_explanation' => 'Pracovní/školní Microsoft účty vyžadují souhlas administrátora organizace, než SyncMyDay může přistupovat k vašemu kalendáři. Jedná se o bezpečnostní funkci Microsoft.',
    'admin_consent_steps_title' => 'Kroky pro vašeho IT administrátora',
    'admin_consent_step_1' => 'Pošlete URL pro admin consent vašemu IT administrátorovi',
    'admin_consent_step_2' => 'Musí kliknout na URL a přihlásit se svým administrátorským účtem',
    'admin_consent_step_3' => 'Zkontroluje a schválí oprávnění (Calendars.ReadWrite, User.Read)',
    'admin_consent_step_4' => 'Po schválení se vraťte sem a zkuste kalendář připojit znovu',
    ...
    'email_forwarding_rule' => 'Pravidlo přeposílání e-mailů:',
    'outlook_step_1' => 'Otevřete Outlook → <strong>Soubor → Spravovat pravidla a upozornění</strong>',
    'outlook_step_2' => 'Klikněte na <strong>Nové pravidlo</strong>',
    'outlook_step_3' => 'Vyberte "Použít pravidlo na zprávy, které obdržím"',
    'outlook_step_4_title' => 'Přidejte podmínky:',
    'outlook_step_4_condition_1' => 's konkrétními slovy v předmětu: <code class="bg-gray-100 px-1">schůzka, pozvánka, meeting, invitation</code>',
    'outlook_step_4_condition_2' => 's přílohou',
    'outlook_step_5' => 'Akce: <strong>Přeposlat na</strong>',
    'outlook_step_6' => 'Klikněte na <strong>Dokončit</strong>',
    'setup_gmail' => '📌 Gmail',
    'gmail_forwarding_filter' => 'Filtr přeposílání v Gmailu:',
    'gmail_step_1' => 'Otevřete Gmail → <strong>Nastavení (⚙️) → Zobrazit všechna nastavení</strong>',
    'gmail_step_2' => 'Přejděte na <strong>Filtry a blokované adresy</strong>',
    'gmail_step_3' => 'Klikněte na <strong>Vytvořit nový filtr</strong>',
    'gmail_step_4' => 'Do pole "Obsahuje slova" zadejte: <code class="bg-gray-100 px-1">filename:ics</code>',
    'gmail_step_5' => 'Klikněte na <strong>Vytvořit filtr</strong>',
    'gmail_step_6' => 'Zaškrtněte <strong>Přeposlat na</strong> a vyberte/přidejte',
    'gmail_step_7' => 'Klikněte na <strong>Vytvořit filtr</strong>',
    'gmail_note' => 'Poznámka: Možná budete muset nejprve ověřit adresu pro přeposílání.',

    // Admin Consent Page
    'url_copied_to_clipboard' => '✓ URL zkopírována do schránky!',
    'admin_redirect_description' => 'Budou přesměrováni na přihlašovací stránku Microsoftu pro ověření jako administrátor.',
    'requested_permissions' => 'Požadovaná oprávnění:',
    'permission_calendars' => 'Čtení a zápis do kalendářů',
    'permission_user' => 'Čtení uživatelského profilu',
    'permission_offline' => 'Udržení přístupu k datům',
    'approval_organization_wide' => 'Schválení platí pro celou vaši organizaci, takže to stačí udělat pouze jednou.',
    'personal_accounts_no_consent' => 'Osobní účty Microsoft (outlook.com, hotmail.com, live.com) nevyžadují souhlas administrátora a fungují okamžitě.',
    'use_template_description' => 'Můžete použít tuto šablonu pro kontaktování IT administrátora:',
    'admin_email_template' => 'Dobrý den,

používám SyncMyDay (https://syncmyday.cz) k synchronizaci pracovních kalendářů. Aplikace vyžaduje souhlas administrátora pro přístup ke kalendářům Microsoft.

Mohl/a byste prosím schválit tuto aplikaci pro naši organizaci? Zde je URL pro admin consent:

:url

Požadovaná oprávnění jsou:
• Calendars.ReadWrite - Pro synchronizaci kalendářových událostí
• User.Read - Pro identifikaci uživatelů
• offline_access - Pro udržení synchronizace při offline režimu

SyncMyDay je ověřená partnerská aplikace Microsoftu zaměřená na synchronizaci kalendářů.

Děkuji!',
    'copy_email_template' => 'Zkopírovat šablonu e-mailu',
    'template_copied_to_clipboard' => '✓ Šablona zkopírována do schránky!',
